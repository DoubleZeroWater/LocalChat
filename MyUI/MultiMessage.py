...
class MultiMessageUI(object):
    def setupUi(self, MultiMessageUI):
        ...
        self.pushButton_4.setGeometry(QtCore.QRect(520, 140, 131, 71))
        font = QtGui.QFont()
        font.setFamily("等线")
        font.setPointSize(14)
        self.pushButton_4.setFont(font)
        self.pushButton_4.setObjectName("pushButton_4")
        self.pushButton_5 = QtWidgets.QPushButton(MultiMessageUI)
        self.pushButton_5.setGeometry(QtCore.QRect(520, 260, 131, 71))
        font = QtGui.QFont()
        font.setFamily("等线")
        font.setPointSize(14)
    ...
    def retranslateUi(self, MultiMessageUI):
        ...
        self.pushButton_5.setText(_translate("MultiMessageUI", "退出语音"))
