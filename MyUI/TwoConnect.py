...
class TwoConnectUI(object):
    def setupUi(self, TwoConnectUI):
        ...
        TwoConnectUI.resize(515, 382)
        self.pushButton = QtWidgets.QPushButton(TwoConnectUI)
        self.pushButton.setGeometry(QtCore.QRect(350, 310, 141, 61))
        font = QtGui.QFont()
        font.setFamily("等线")
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(30, 310, 141, 61))
        font = QtGui.QFont()
        font.setFamily("等线")
        font.setPointSize(14)
        ...
        self.Connecting.setGeometry(QtCore.QRect(200, 310, 141, 51))
        font = QtGui.QFont()
        font.setFamily("等线")
        font.setPointSize(14)
        ...
        self.OpenPort.setGeometry(QtCore.QRect(280, 250, 211, 41))
        font = QtGui.QFont()
        font.setFamily("等线")
        font.setPointSize(14)
        ...
        self.IPToConnect.setGeometry(QtCore.QRect(280, 190, 211, 41))
        font = QtGui.QFont()
        font.setFamily("等线")
        font.setPointSize(14)
        ...
        self.PortToConnect.setGeometry(QtCore.QRect(280, 130, 211, 41))
        font = QtGui.QFont()
        font.setFamily("等线")
        font.setPointSize(14)
        ...
        self.Nickname.setGeometry(QtCore.QRect(280, 70, 211, 41))
        font = QtGui.QFont()
        font.setFamily("等线")
        font.setPointSize(14)
        ...
        self.IP.setGeometry(QtCore.QRect(280, 10, 211, 41))
        font = QtGui.QFont()
        font.setFamily("等线")
        font.setPointSize(14)
        ...
        self.widget = QtWidgets.QWidget(TwoConnectUI)
        self.widget.setGeometry(QtCore.QRect(30, 10, 255, 281))
